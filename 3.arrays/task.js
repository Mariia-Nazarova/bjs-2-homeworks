////////////////////////////ДОМАШКА №4.1//////////////////////////////////////////////////////
/*УСЛОВИЕ:Создайте функцию compareArrays(arr1, arr2), которая с помощью функции высшего порядка будет сравнивать значения двух массивов.*/

function compareArrays(arr1, arr2) {
    /* 1-м делом смотрим длину, если не совпадает, то дальше сравнивать нет смысла  */
  ...
  ////////////////////////////ДОМАШКА №4.2//////////////////////////////////////////////////////
  /*УСЛОВИЕ:Создайте функцию getUsersNamesInAgeRange(users, gender), которая возвращает среднее значение возраста пользователей одного пола.
  ...
  function getUsersNamesInAgeRange(users, gender) {
    // возьмём метод filter для получения нужных пользователей.
    const filteredUsers = users.filter((users) => users.gender === gender); 
  
    /* чтобы не nan, т.е. проверяем сразу есть ли вообще нужный нам гендер в массиве*/
